...
public class Recommendor {
   ...
   try{
	...
	String FILENAME = "/home/shreyas/scripts/testset.arff";
	...
	Classifier j48tree = new J48();
        Instances train = new Instances(new BufferedReader(new FileReader("dataset.arff")));
        int lastIndex = train.numAttributes() - 1;
            
        train.setClassIndex(lastIndex);
            
        Instances test = new Instances(new BufferedReader(new FileReader("testset.arff")));
